...
ＶＴＬ＿ｏｎ＿ＦＰＧＡは、ＦＰＧＡ上でＶＴＬ言語を動作させるための開発環境です。  
処理速度向上のために、ＶＴＬ言語をコンパイルしてから実行させます。  
コンパイルはパソコン上もしくはＦＰＧＡ上で行うことができます。  

１．ＶＴＬ＿ｏｎ＿ＦＰＧＡの機能を下記で解説しています
...
２．ＴＤ４ｘ４ 命令一覧  
　ＶＴＬ＿ｏｎ＿ＦＰＧＡはＴＤ４ｘ４(独自１６ｂｉｔＣＰＵ)で動作しています。  
  ＣＰＵの命令一覧を下記に示します。  
